...
// Listen for the "start" message from background.js
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
  // CRITICAL FIX: Check if paused first
  chrome.storage.local.get("paused").then((data) => {
    if (data.paused) {
      console.log("Ext is paused. Scanning disabled.");
      return; // Stop execution immediately if paused
    }

    // Existing logic continues only if NOT paused
...
function blockerFunction() {
  ...
  const analList = [
    ...
    /ex.co/,
    /\/launch\/launch\-/,
    /.com\/id\?d\_visid\_ver/,
    /marketo/,
    /simpleanalyticscdn.com/,
    /cdn.amplitude/,
    /ki.js/,
    /youtube.com\/ptracking/,
    /youtube.com\/pcs\/parallelactiveview/,
    /youtube.com\/api\/stats\/playback\//,
    /youtube.com\/pcs\/activeview/,
    /googleusercontent.com\/proxy\//,
    /cdn.yottaa.com\/rapid/,
    /cdn.matomo./,
    /cdn.pbbl.co/,
    /oracleinfinity/,
    /t.paypal.com\/ts/,
    ...
    /vercel-insights/,
    /.apxlv.com\//,
    /.mutinycdn.com\/personalize\//,
    /reveal.clearbit.com/,
    /tracking.g2crowd.com\//,
    /akamaihd.net/,
    /sitesearch360.com/,
    /api.ipdata.co/,
    /\/analytics\/preloadInit.js/,
    /\/analytics\/segment\/init-production.js/,
    /cdn.dynamicyield.com\/api/,
    /browser-intake-datadoghq.com/,
    /tracker.affirm.com/,
    /cdn.rollbar.com\/rollbarjs/,
    /sentry.io\/api/,
    /web-assets.zendesk.com\/js\/analytics/,
    /.levexis.com/,
    /mybluemix.net/,
    ...
    /\/\/unagi.amazon./,
    /ns1p.net/,
    /avalon.perfdrive.com/,
    /sstats.adobe.com/,
    /xp.apple./,
    /supportmetrics.apple./,
    /.heatmap.it/,
    /.t-online.de\//,
    /speedcurve/,
    /ysucej/,
    ...
    /.amagi.tv\/beacon/,
    /llnwd.net/,
    /analytics.shareaholic/,
    /partner.shareaholic/,
    /loomi-prod.xyz\/analytics/,
    ...
    /pages.ebay.com\/identity\/device/,
    /devicebind.ebay/,
    /rover.ebay/,
    /gh\/useracquisition\/userbehavior?/,
    /gh\/dfpsvc?/,
    /backstory.ebay/,
    /cdn.speedcurve/,
    /testandtarget\/clientlibs/,
    /ced.sascdn.com/,
    /s0.wp./,
    /discover-metrics.cloud./,
    ...
    /fls-na.amazon.com/,
    /unagi.amazon/,
    /amazon.com\/service\/web\/content\/uploadMetrics/,
    /js.trendmd/,
    /nytimes.com\/track/,
    /disqus.com\/count.js/,
  ...
  const adList = [
    ...
    /pix.pub/,
    /mail\-ads.google.com\/mail/,
    /edge.api.brightcove.com/,
    /hotzones\/src\//,
    /floodlight\_global.js/,
    /tags.bkrtx/,
    /d9.flashtalking/,
    /servedby.flashtalking/,
    /mmstat.com/,
    /refersion.com\/tracker/,
    /\/comscore./,
    /.en25.com\//,
    /evgnet.com/,
    /gscontxt.net/,
    ...
    /ttvnw.net/,
    /adtechus/,
    /yahoo.com\/info\/p.gif/,
    /yahoodns/,
    /akamaized/,
    /serving-sys.com\/adServingData/,
    /.components.video-ads/,
    ...
    /cdn.adpushup/,
    /.ad.gt/,
    /kinja-static.com\/assets\/new-client\/trackers/,
    /ad.turn.com/,
    /bfmio.com/,
    /emxdgt.com/,
    /inmobi.com/,
...
`console.log(foundHTTPADArray);*/
  ...
  if (totalTot === 0) {
    ...
    for (var i = 0; i < analList.length; i++) {
      strIframeMatches = iframeSrcs.filter((element) =>
        analList[i].test(element),
      );
    ...
    for (var i = 0; i < adList.length; i++) {
      striFrameAdMatches = iFrameAdSrcs.filter((element) =>
        adList[i].test(element),
      );
  ...
  try {
    ...
    if (totalTot === 0 && iframes.length >= 1) {
      ...
      var iframeOuterHTML =
        document.getElementsByTagName("iframe")[0].contentWindow.document.head
          .outerHTML;

      iframeTextAr.push(iframeOuterHTML);

      for (var i = 0; i < analList.length; i++) {
        foundTextMat = iframeTextAr.filter((element) =>
          analList[i].test(element),
        );
      ...
      for (var i = 0; i < adList.length; i++) {
        foundTextMatAd = iframeTextArAd.filter((element) =>
          adList[i].test(element),
        );
