...
/adobedtm/, /qualaroo/, /clicktale/, /funnelenvy/, /edge\.fullstory/, /tvsquared/, /heapanalytics/,
 ...
 /6sc\.co/, /demandbase/, /engagio/, /akamai/, /qualtrics/, /rubiconproject/, /s\.yimg/,
  ...
  /rmtag/, /impactradius\-event/, /bytedance/, /sprig/, /userleap/, /taboola/, /sleeknote/, /pushcrew/, /onesignal/, /amplify\-outbrain/, /dianomi/, /s\-onetag/, /crwdcntrl/, /redditstatic/, /quantserve/, /rubiconproject/, /mpulse/, /\.demex\.net\//, /gateway\.foresee\.com/, /\.scene7/, /googletagservices/, /analytics\.yahoo\.com/, /doubleverify/, /imrworldwide/, /analytics\.twitter/, /bidswitch/, /widgets\-outbrain/, /connect\.facebook\.net/, /igodigital/, /api\-segment/, /ad\-delivery/, /pix\.pub/, /nr\-data/, /c\.lytics/, /indexww/, /p1\.parsely/, /omtrdc/, /curalate/, /richrelevance/, /cquotient/, /api\.drift/, /app\.dynamics/, /pixel\.wp/, /s7\.addthis/, /webtrendslive/, /googleoptimize/, /px\-cloud\.net/, /liveperson/, /tamgrt/, /\.forter/, /piwik/, /3gl\.net/, /btttag/, /crwdcntrl\.net/, /exelator/, /helpscout/, /platform\.twitter/, /linkedin\.com\/li\/track/, /tvsquared/, /fullstory/, /powerreviews/, /mouseflow/, /brightcove/, /beacon\.walmart\.com/, /mathtag/, /\/clickstream\//, /\/gauge\/link\//, /\/gauge\/pageview\//, /bs\.serving\-sys/, /dyntrace/, /custhelp/, /answerscloud/, /yotpo/, /kampyle/, /webcollage/, /salsify\-ecdn/, /ct\.pintrest/, /soptimize\.southwest/, /flashtalking/, /innovid/, /facebook\.com\/tr/, /everesttech/, /r\.turn/, /content\.mink/, /siteimproveanalytics/, /newscgp/, /permutive/, /js\+ssdomvar\.js\+generic/, /snowplowanalytics/, /6sc\.co/, /bluekai/, /usabilla/, /xg4ken/, /api\.amplitude/, /\/b\/ss\//, /quantummetric/, /\/wt\.pl\?/, /spotxchange/, /mookie1/, /\/glassbox\/reporting\//, /\/ga\/gtag\.js/, /\/plugins\/like\.php/, /maxymiser\.net\//, /visualwebsiteoptimizer/, /d\.turn/, /branch\.io/, /res\-x/, /narrativ/, /dcf\.espn/, /bluecore/, /yjtag\.yahoo/, /ruxitagent/, /plausible\.io\/js/, /jscache/, /acuityplatform/, /cloudfront\.net\/form\-serialize/, /mr\.homedepot/, /static\/js\/t\.js/, /dotmetrics\.net/, /hit\.xiti/, /plusone\.js/, /kaltura/, /tagcommander/, /boomerang\.js/, /techlab\-cdn/, /3lift/, /searchiq/, /\/js\/tealeaf/, /appboy\.com\/api/, /sharethis\.com/, /bizible/, /getclicky\.com\/js/, /track\.securedvisit/, /online\-metrix/, /dynamicyield/, /yottaa/, /atgvcs/, /agkn\.com/, /t\.co\//, /data\.microsoft/, /quantcast/, /cdn\.pdst/, /sgtm/, /flashtalking/, /owneriq/, /shoprunner/, /osano/, /gigya/, /log\.pinterest/, /hubspot/, /pinimg/, /\/opinionlab\//, /merkle\_track/, /ensighten/, /alexametrics/, /tr\.snapchat/, /c\.msn/, /keywee/, /bizographics\.com\/collect/, /omnitagjs/, /yandex\.ru\/metrika\/a/, /evidon\-sitenotice\-tag\.js/, /dotomi/, /lijit/, /bluecava/, /data\.pendo\.io/, /heapanalytics/, /certona/, /sail\-horizon\.com\/spm/, /\.gumgum\.com/, /mparticle/, /privy\.com\/collect/, /abtasty/, /dwin1/, /shopifycdn/, /uplift\-platform/, /w55c/, /liadm/, /sddan/, /sundaysky/, /\/atrk\.js/, /\/kinesis/, /zdassets/, /rfihub/, /ex\.co/, /\/launch\/launch\-/, /\.com\/id\?d\_visid\_ver/];
    
    
const adList = [/doubleclick/,/scorecardresearch/,/marketo/,/krxd\.net/,/adservice\.google/,/googleadservices/,/geoedge/,/ads\-twitter/,/amazon\-adsystem/,/ads\.pubmatic/, /adroll/, /adnxs/, /ads.\linkedin/, /moatads/, /criteo/, /adlightning/, /turner\.com\/ads/, /adsafeprotected/, /sc\-static/, /px\.ads\.linkedin/, /adsrvr/, /monetate/, /apps\.bazaarvoice/, /tapad/, /casalemedia/, /ads\.stickyadstv/, /pubmatic\.com\/AdServer/, /ispot\.tv/, /fwmrm\.net\/ad/, /cxense/, /adsymptotic/, /yahoo\.com\/admax/, /\.brsrvr/, /advertising/, /ad\.360yield/, /ad\.wsod/, /teads\.tv/, /tvpixel/, /www\.youtube\.com\/pagead/, /.impact\-ad./, /pubmatic.com\/AdServer\//, /\/player\/ad_break/, /\/api\/stats\/ads/, /33across/, /bat\.bing/];
...
var totalAd = iframeAdCount+imgAdCount+scrptAdCount;
